...
?>
<?php
    include("../crud/topRate_worldBest.php")
?>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="dashboard">
        <div class="body">
            ...
            <div class="space">
                    ...
                    <div class="text mt-3"><p> Top Rate and World Best</p></div>
                ...
                <div class="item" >
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content text-white" style="background-image: url(../front/image/banner.jpg);">
                                    <div class="modal-header">
                                        <h5 class="modal-title " id="exampleModalLongTitle" >Insert Upcoming</h5>
                                    ...
                                    <div class="modal-body">
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="">HD</label>
                                                <input type="text" name="txt_hd" class="form-control">
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="">Hour</label>
                                                <input type="text" name="txt_hour" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="">Star</label>
                                                <input type="text" name="txt_star" class="form-control">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <select name="txt_types" id="" class="form-control">
                                                    <option value="topRate">topRate</option>
                                                    <option value="worldBest">worldBest</option>
                                                </select>
                                            </div>

                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                                                <button type="submit" name="btn-topRate_worldBest" class="btn btn-success">Insert</button>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <table id="example" class="container w-100  table-striped table-dark "  >
                            ...
                            <tbody>
                                <?php
                                $top_world_sql     = "SELECT * FROM `tb_toprate_and_worldbest`";
                                $top_world_result  = $connect->query($top_world_sql);
                                if($top_world_result->num_rows>0){
                                    $index = 1;
                                    while($row = $top_world_result->fetch_assoc()){
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><img style="width: 35px;height: 35px;"src="../topRate_worldBest_image/<?=$row['photo']?>" alt=""></td>
                                        <td>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content text-white" style="background-image: url(../front/image/banner.jpg);">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="">Date</label>
                                                        <input type="text" name="txt_date" class="form-control" value="<?=$row['date']?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">HD</label>
                                                        <input type="text" name="txt_hd" class="form-control" value="<?=$row['HD']?>">
                                                    </div>
                                                    
                                                    <div class="form-group">
                                                        <label for="">Hour</label>
                                                        <input type="text" name="txt_hour" class="form-control" value="<?=$row['hour']?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">Star</label>
                                                        <input type="text" name="txt_star" class="form-control" value="<?=$row['star']?>">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <select name="txt_types" id="" class="form-control" value="<?=$row['tpye']?>">
                                                            <option value="topRate">topRate</option>
                                                            <option value="worldBest">worldBest</option>
                                                        </select>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                                                        <button type="submit" name="btn-edit-top_world" class="btn btn-success">Edit</button>
                                                    </div>
                                     ...
                                     <div class="modal fade" id="deleteModel<?=$row['id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true" >
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content text-dark" style="background-image: url(../front/image/banner.jpg);">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="post" enctype="multipart/form-data">
                                                        <p>Do you want to delete this Top Rate or World Best ?</p>
                                                        <div class="form-group">
                                                            <input type="hidden" name="txt_id" class="form-control" value="<?=$row['id']?>">
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                            <button type="submit" name="btn-topworld" class="btn btn-danger">Delete</button>
                                                        </div>
                                                    </form>
                                                </div>
