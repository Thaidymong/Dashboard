                    ...
                    <div class="item">
                        ...
                        <div class="box1 ">
                            ...
                            <div class="name  active">
                                <p><a href="../logout.php" class="text-gray">Register List</a></p>
                            </div>
                        </div>
            ...
            <div class="space">
                ...
                <div class="item" >
                                    ...
                                    <div class="modal-body">
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" name="btn-submit-upcoming" class="btn btn-success">Insert</button>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <table id="example" class="container w-100  table-striped table-dark "  >
                            ...
                            <tbody>
                                <?php
                                $upcoming_sql     = "SELECT * FROM `tb_upcoming`";
                                $upcoming_result  = $connect->query( $upcoming_sql);
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?=$row['hour']?></td>
                                        <td><?=$row['star']?></td>
                                        <td><img style="width: 35px;height: 35px;"src="../upcoming_image/<?=$row['photo']?>" alt=""></td>
                                        <td>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content text-white" style="background-image: url(../front/image/banner.jpg);">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                                                        <button type="submit" name="btn-edit-upcoming" class="btn btn-success">Edit</button>
                                                    </div>
                                                </form>
                                                </div>
                                    ...
                                    <div class="modal fade" id="deleteModel<?=$row['id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true" >
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content text-white" style="background-image: url(../front/image/banner.jpg);">
                                                <div class="modal-header">
                                                    <h5 class="modal-title " id="exampleModalLongTitle" >Delete Upcoming</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                ...
                                                <form action="" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" name="btn-delete-upcoming" class="btn btn-danger">Delete</button>
                                                    </div>
                                                </form>
                                                </div>
