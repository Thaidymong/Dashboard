            ...
            <div class="space">
                ...
                <div class="item" >
                                    ...
                                    <div class="modal-body">
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" name="btn-submit-banner" class="btn btn-success">Insert</button>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <table id="example" class="container w-100  table-striped table-dark "  >
                            ...
                            <tbody>
                                <?php
                                $banner_sql     = "SELECT * FROM `tb_banner`";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?=$row['date']?></td>
                                        <td><?=$row['hour']?></td>
                                        <td><img style="width: 35px;height: 35px;"src="../banner_image/<?=$row['banner']?>" alt=""></td>
                                        <td>
                                            ...
                                            <div class="modal-content text-white" style="background-image: url(../front/image/banner.jpg);">
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="">Romance</label>
                                                            <input type="text" name="txt_romance" class="form-control" value="<?=$row['romance']?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="">Drama</label>
                                                            <input type="text" name="txt_drama" class="form-control" value="<?=$row['drama']?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="">Date</label>
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                                                            <button type="submit" name="btn-edit-banner" class="btn btn-success">Edit</button>
                                                        </div>
                                                    </form>
                                                </div>
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" name="btn-delete-banner" class="btn btn-danger">Delete</button>
                                                        </div>
                                                    </form>
                                                </div>
